...
let _ = Callback.register_exception "Unix.Unix_error_r"
                                    (Unix_error(E2BIG, "", ""))
...
external execv : string -> string array -> 'a = "unix_execv_r" "reentrant"
external execve : string -> string array -> string array -> 'a = "unix_execve_r" "reentrant"
external execvp : string -> string array -> 'a = "unix_execvp_r" "reentrant"
external execvpe : string -> string array -> string array -> 'a = "unix_execvpe_r" "reentrant"
external fork : unit -> int = "unix_fork_r" "reentrant"
external wait : unit -> int * process_status = "unix_wait_r" "reentrant"
external waitpid : wait_flag list -> int -> int * process_status = "unix_waitpid_r" "reentrant"
...
external unsafe_write : file_descr -> string -> int -> int -> int = "unix_write_r" "reentrant"
external unsafe_single_write : file_descr -> string -> int -> int -> int = "unix_single_write_r" "reentrant"
...
module LargeFile =
  struct
    external lseek : file_descr -> int64 -> seek_command -> int64 = "unix_lseek_64_r" "reentrant"
...
external pipe : unit -> file_descr * file_descr = "unix_pipe_r" "reentrant"
...
external select :
  file_descr list -> file_descr list -> file_descr list -> float ->
        file_descr list * file_descr list * file_descr list = "unix_select_r" "reentrant"
...
external accept : file_descr -> file_descr * sockaddr = "unix_accept_r" "reentrant"
...
external unsafe_sendto :
  file_descr -> string -> int -> int -> msg_flag list -> sockaddr -> int
                                  = "unix_sendto_r" "reentrant" "unix_sendto_native_r"
