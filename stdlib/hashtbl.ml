...
external seeded_hash_param : int -> int -> int -> 'a -> int = "caml_hash_r" "noalloc" "reentrant"
external old_hash_param : int -> int -> 'a -> int = "caml_hash_univ_param_r" "noalloc" "reentrant"
